...
public class SC_InventorySystem : MonoBehaviour
{
    ...
    void Start()
    {
       ...
       // availableItems = new SC_PickItem[9];
        ...
        if (Physics.Raycast(ray, out hit, 2.5f))
        {
            ...
            if (objectHit.CompareTag("Respawn"))
            {
                if ((detectedItem == null || detectedItem.transform != objectHit) && objectHit.GetComponent<SC_PickItem>() != null)
                {
                    ...
                    {
//                        Debug.Log(availableItems[i].itemName);
//                        Debug.Log(itemTmp.itemName);
                        if (availableItems[i].itemName != null)
                        {
    ...
    {
        //Inventory UI
        GUI.Label(new Rect(5, 5, 200, 25), "TAB para abrir inventario");
        ...
        if (windowAnimation < 1)
        {
            ...
            GUILayout.Label("Inventario", GUILayout.Height(25));
        ...
        if (!showInventory)
        {
            ...
            if (detectedItem)
            {
                ...
                GUI.Label(new Rect(Screen.width / 2 - 75 + 1, Screen.height / 2 - 50 + 1, 150, 20), "Presiona 'F' para coger '" + detectedItem.itemName + "'");
                GUI.color = Color.green;
                GUI.Label(new Rect(Screen.width / 2 - 75, Screen.height / 2 - 50, 150, 20), "Presiona 'F' para coger '" + detectedItem.itemName + "'");
            }
        }
    }
}